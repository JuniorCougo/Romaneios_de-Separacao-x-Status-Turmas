...
#Romaneio Supply_Sem_Aprovação#Este deu certo
...
df1 = pd.read_excel(r"C:\Users\sar8577\Documents\AA_DATA FRAME_PYTHON\df_romaneio_supply_sem_aprovacao.xlsx")
df2 = pd.read_excel(r"C:\Users\sar8577\Documents\AA_DATA FRAME_PYTHON\df_listagemTurmas.xlsx")#atentar a extensão do arquivi
#"C:\Users\sar8577\Documents\AA_DATA FRAME_PYTHON\df_listagemTurmas.xls"#
#"C:\Users\sar8577\Documents\AA_DATA FRAME_PYTHON\df_romaneio_supply_sem_aprovacao.xlsx"

# Pré-processamento dos DataFrames (se necessário)
